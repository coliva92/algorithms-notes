...
\marginnote[1\baselineskip]{Hay muchas otras características que podrían ser de interés, dependiendo de la aplicación del algoritmo que se está analizando. Por ej., una característica frecuentemente estudiada es el orden de crecimiento de la cantidad de memoria ocupada por el algoritmo con respecto al tamaño de la entrada.}
...
\marginnote[-2\baselineskip]{\textbf{Literatura consultada}: \textcite{cormen_introduction_2009}, págs. 5-14 y 20-22; \textcite{skiena_algorithm_2012}, págs. 3-13.}
