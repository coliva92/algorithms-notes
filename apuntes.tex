...
\begin{document}
  ...
  \input{capitulos/secuenciales/conceptos}
  % \input{secuenciales/correccion}
  % \input{secuenciales/asintotica}
  % \input{secuenciales/eficiencia}
  % \input{secuenciales/recurrencias}
  
  \appendix
    % \input{apendices/redaccion}%% mover a matematicas discretas
    \input{anexos/potencia}
    \input{anexos/logaritmo}
